...
import E4HJobApplication from "./pages/ApplyPage";
...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: '/apply-job', element: <SuspenseWrapper><E4HJobApplication /></SuspenseWrapper> },
         ...
         { path: '/get-involved', element: <SuspenseWrapper><GetInvolvedPage /> </SuspenseWrapper> },
