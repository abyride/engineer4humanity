      ...
      <div className="max-w-6xl flex flex-col md:flex-row items-center">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold">
            Packages <span className="text-primary-500">Softwares</span>, Sells For You.
          </h2>
          ...
          <ul className="mt-6 space-y-3">
            <li className="flex items-center">
              <FaRegCheckCircle className="text-primary-500 mr-2" /> We Create Software Applications.
            </li>
            <li className="flex items-center">
              <FaRegCheckCircle className="text-primary-500 mr-2" /> We Deliver Software Services.
            </li>
            <li className="flex items-center">
              <FaRegCheckCircle className="text-primary-500 mr-2" /> We Deliver On Time.
            </li>
          </ul>
        </div>
      </div>
